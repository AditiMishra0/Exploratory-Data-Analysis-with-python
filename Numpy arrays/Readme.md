...
NumPy (Numerical Python) is the foundational library for scientific computing in Python. Numpy has a function called as ndarray (n-dimensional array), a data structure designed for speed, memory efficiency, and mathematical elegance.

### Aim:

To study about the basic tools used for EDA using NumPy arrays
